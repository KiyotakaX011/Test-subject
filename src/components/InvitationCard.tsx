    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 flex items-center justify-center p-4 relative overflow-hidden">
      ...
      >
        <div className="bg-slate-800/80 backdrop-blur-xl rounded-3xl p-8 md:p-12 border-2 border-pink-500/30 shadow-[0_0_50px_rgba(255,64,232,0.3)]">
          ...
          >
            <h1 className="text-5xl md:text-7xl font-bold mb-4 bg-gradient-to-r from-pink-500 via-purple-500 to-cyan-400 bg-clip-text text-transparent">
              FAREWELL
            </h1>
            <motion.h2
          ...
          >
            <div className="flex items-center gap-4 text-white p-4 rounded-xl bg-slate-700/50 border border-cyan-400/30 hover:border-cyan-400 transition-all duration-300">
              <MapPin className="w-6 h-6 text-cyan-400" />
              <span className="text-lg font-semibold">Havana by Ramada</span>
            </div>

            <div className="flex items-center gap-4 text-white p-4 rounded-xl bg-slate-700/50 border border-purple-400/30 hover:border-purple-400 transition-all duration-300">
              <Calendar className="w-6 h-6 text-purple-400" />
              <span className="text-lg font-semibold">Farewell Day</span>
            </div>

            <div className="flex items-center gap-4 text-white p-4 rounded-xl bg-slate-700/50 border border-yellow-400/30 hover:border-yellow-400 transition-all duration-300">
          ...
          <motion.div
            ...
            className="mb-8 p-6 rounded-xl bg-gradient-to-br from-slate-700/50 to-slate-800/50 border border-pink-500/30"
          >
            <h3 className="text-xl font-bold text-pink-500 mb-4">Organized By</h3>
            <div className="grid md:grid-cols-2 gap-4">
              <div className="text-white">
                <p className="font-bold text-lg">Rohit Singh</p>
                <a
                  href="tel:+917819037576"
                  className="flex items-center gap-2 text-cyan-400 hover:text-pink-500 transition-colors"
                >
